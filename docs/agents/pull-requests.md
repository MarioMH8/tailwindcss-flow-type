...
1. Open an issue using the [Bug Report](https://github.com/MarioMH8/tailwindcss-flow-type/issues/new?template=bug_report.yml) or [Feature Request](https://github.com/MarioMH8/tailwindcss-flow-type/issues/new?template=feature-request.yml) template.
...
```
feat(scope): add fluid-heading preset
fix(scope): handle missing theme variable gracefully
```
